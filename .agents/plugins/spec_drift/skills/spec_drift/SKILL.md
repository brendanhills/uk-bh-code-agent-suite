---
name: spec_drift
description: Audits the codebase against the Conductor Master Specification (or SDD) to detect architecture, endpoint, and data drift, generating a structured Discrepancy Review Matrix.
---
...
1. Look for the project's Master Specification Document:
   ...
   - Alternatively, search for any designated SDD/BRD markdown file in the workspace.
2. If no specification is found, notify the user and prompt for the target spec file.
